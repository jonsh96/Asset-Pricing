function [t_lambda, lambda, alpha, beta, gamma, covariance, dates, excess_returns] = runRegression(startDate, endDate, data, risk_free_data, excess_return_data, market_data, monthly_data, liquidity_data, factorIndex)
